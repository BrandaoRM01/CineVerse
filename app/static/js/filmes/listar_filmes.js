document.addEventListener('DOMContentLoaded', async () => {
    let lista_filmes = document.querySelector('#lista-filmes');
    ...
    try {
        let resp_filmes = await fetch('/filmes/listar');
        filmes = await resp_filmes.json();
    }
    catch {
        lista_filmes.innerHTML = `
            <p class="text-danger text-center">Não foi possível carregar os filmes.</p>
        `;
        return;
    }
    ...
    if (filmes.length === 0) {
        lista_filmes.innerHTML = `
            <p class="text-center text-light">Nenhum filme cadastrado ainda.</p>
        `;
        return;
    }
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                ...
                <div class="card bg-black text-light shadow h-100 border-secondary d-flex flex-column">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a 
                            href="/detalhes_filme/${filme.tmdb_id}" 
                            class="btn btn-outline-danger w-100 mt-auto mb-3"
                        >
                            Ver mais
                        </a>
